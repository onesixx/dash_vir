...
from .model import *
from frontend.common.dconsts import RACK_COLOR

#from wsgiapp import app_dash
...
# # ---- Label 1 Change
# @app_dash.callback(Output("lbl_date1", "children"),
...
#         compare_data = compare_data[['serial_dt', 'bank_no', 'current', 'voltage', 'avg_temp']].groupby(
#             ['serial_dt', 'bank_no'], as_index=False).mean()
#         # ----- 비교 데이타의 시간 맞추기
#         cha_time = data['serial_dt'].min()-compare_data['serial_dt'].min()
#         compare_data['serial_dt'] = compare_data['serial_dt'] + cha_time
#         compare_data['dtime'] = compare_data['serial_dt'].map(
...
#         subtitle="Data Count [" +
#         str(box_data.iloc[0]['datacount_per']) + "%]",
...
#     pio.templates.default = "plotly_white"
#     plot_template = ('plotly', 'ggplot2', 'seaborn', 'simple_white', 'plotly_white',
...
#     # fig.update_yaxes(visible=True, fixedrange=True)
#     # 마우스 오버시 x , y 라인을 보여줌.
#     fig.update_xaxes(showspikes=False, spikecolor="green",
